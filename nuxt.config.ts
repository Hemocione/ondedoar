  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: "description",
          content: "Encontre a oportunidade de doar sangue mais próximo de você.",
        },
        { name: "format-detection", content: "telephone=no" },
        { property: 'og:title', content: 'Onde Doar Sangue - Hemocione' },
        { property: 'og:description', content: 'Encontre a oportunidade de doar sangue mais próximo de você.' },
        { property: 'og:image', content: `${siteUrl}/HemocioneLogo.svg` },
        { property: 'og:url', content: siteUrl },
        { property: 'og:type', content: 'website' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Onde Doar Sangue - Hemocione' },
        { name: 'twitter:description', content: 'Encontre a oportunidade de doar sangue mais próximo de você.' },
        { name: 'twitter:image', content: `${siteUrl}/HemocioneLogo.svg` },
      ],
